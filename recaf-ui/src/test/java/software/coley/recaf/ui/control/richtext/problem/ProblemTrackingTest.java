...
class ProblemTrackingTest {
	...
	void removeByPhase() {
		...
		tracking.add(new Problem(0, 0, ERROR, LINT, "message-err-lint"));
		tracking.add(new Problem(0, 0, WARN, LINT, "message-warn-lint"));
		tracking.add(new Problem(0, 0, ERROR, BUILD, "message-err-build"));
		tracking.add(new Problem(0, 0, WARN, BUILD, "message-warn-build"));
		tracking.add(new Problem(0, 0, ERROR, POST_PROCESS, "message-err-proc"));
		tracking.add(new Problem(0, 0, WARN, POST_PROCESS, "message-warn-proc"));
